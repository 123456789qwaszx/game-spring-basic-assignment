package com.gamebasic.ranking.testfixture;
...
public final class RankingRecordFixture {
    ...
    public static final Set<String> ALLOWED_CARD_TYPES =
    ...
    public static Builder validCandidate() {
        return new Builder();
    }

    public static RankingRecord.Deck deck(
    ...
    public static RankingRecord.Deck.Card card(
            String cardType,
    ...
    public static RankingRecord.Deck deckContaining(
    ...
    public static RankingRecord.BossFight.Phase phase(
            String phase,
            Integer turns,
            Integer damageTaken
    ) {
    ...
    public static RankingRecord.BossFight bossFightWithPhases(
    ...
    public static RankingRecord.BossFight bossFightWithTurns(
            int throneTurns,
            int unboundTurns,
            int eclipseTurns
    ) {
    ...
    public static RankingRecord.BossFight bossFightWithTurnsAndTotal(
            int throneTurns,
            int unboundTurns,
            int eclipseTurns,
            int totalTurns
    ...
    public static RankingRecord.BossFight bossFightWithFinishingCard(
    ...
    public static final class Builder {
        ...
        public Builder clearedFloor(Integer clearedFloor) {
        ...
        public Builder finalHp(Integer finalHp) {
            this.finalHp = finalHp;
            return this;
        }

        public Builder deck(RankingRecord.Deck deck) {
            this.deck = deck;
            return this;
        }

        public Builder bossFight(
